...
alternative_solution[41]  = [
								[ [1,21], [0,4],    [3,19],   [0,18], [1,10], [0,6]    ]
							];
...
alternative_solution[74]  = [
								[ [0,2],  [5,26],   [2,1],    [3,19], [2,12], [3,22]   ]
							];
alternative_solution[105] = [ 
								[ [0,7],  [5,15],   [4,14,m], [0,16], [3,26], [5,11]   ]
							];
alternative_solution[171] = [ 
								[ [1,3],  [3,14],   [5,25],   [0,4],  [3,6],  [2,10,m] ]
							];
alternative_solution[173] = [ 
								[ [0,2],  [1,9,m],  [5,25,m], [3,19], [0,0],  [2,13]   ]
							];
...
alternative_solution[259] = [
								[ [0,22], [5,18],   [0,25,m], [3,19], [0,0],  [3,11,m] ]
							];
alternative_solution[271] = [
								[ [1,5],  [0,24],   [5,21,m], [1,1],  [0,12], [0,6]    ]
							];
...
solution[36]  = [ [0,22], [0,9,m],  [2,2,m],  [5,20], [4,18], [3,6,m]  ];
solution[39]  = [ [1,4],  [5,26],   [4,19],   [1,12], [0,1],  [3,22]   ];
solution[41]  = [ [0,9],  [0,4],    [3,19],   [0,18], [4,24], [0,6]    ];
solution[44]  = [ [0,9],  [1,6,m],  [3,8],    [2,11], [3,23], [2,16,m] ];
solution[46]  = [ [0,9],  [0,17],   [0,24,m], [4,4],  [0,2],  [1,21,m] ];
...
solution[59]  = [ [1,22], [0,4],    [5,20],   [0,13], [3,16], [0,6]    ];
...
solution[69]  = [ [0,13], [1,0,m],  [5,21,m], [2,8],  [3,17], [2,18]   ];
solution[72]  = [ [1,21], [5,26],   [2,1],    [3,19], [5,6],  [0,15]   ];
solution[74]  = [ [1,11], [5,26],   [2,1],    [3,19], [5,6],  [3,22]   ];
...
solution[171] = [ [0,0],  [3,14],   [5,25],   [0,4],  [0,2],  [2,10,m] ];
solution[173] = [ [1,0],  [1,9,m],  [5,25,m], [3,19], [3,7],  [2,13]   ]; // pair with 171
...
solution[210] = [ [1,0],  [5,26,m], [3,8],    [5,20], [0,10], [1,7]    ];
...
solution[230] = [ [0,2],  [1,16],   [2,1],    [5,20], [2,14], [4,12,m] ];
solution[233] = [ [1,0],  [4,18,m], [3,8],    [5,9],  [0,21], [1,7]    ];
solution[236] = [ [1,11], [5,18],   [3,8,m],  [0,4],  [3,25], [5,10]   ];
...
solution[386] = [ [0,13], [3,3],    [2,1],    [3,26], [4,24], [3,7,m]  ];
...
solution[549] = [ [0,21], [5,19,m], [3,7],    [3,26], [1,10], [5,17,m] ];
